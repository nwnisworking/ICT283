...
void Test3() {
  ...
  cout << "After inserting elements: Size: " << vec.GetSize() << endl;
}
...
void Test8() {
  ...
  cout << "Before deletion: Size: " << vec.GetSize() << endl;
  for (int i = 0; i < vec.GetSize(); ++i) {
    cout << "Element at index " << i << ": " << vec[i] << endl;
  }
  vec.Delete(1);

  cout << "After deleting element at index 1: Size: " << vec.GetSize() << endl;
...
void Test9() {
  ...
  cout << "After attempting invalid deletions: Size: " << vec.GetSize() << endl;
}
...
void Test11(){
  ...
  cout << "Before modification: Size: " << vec.GetSize() << endl;
  for (int i = 0; i < vec.GetSize(); ++i) {
    cout << "Element at index " << i << ": " << vec[i] << endl;
  }
  ...
  cout << "After modification: Size: " << vec.GetSize() << endl;
  for (int i = 0; i < vec.GetSize(); ++i) {
    cout << "Element at index " << i << ": " << vec[i] << endl;
  }
}
